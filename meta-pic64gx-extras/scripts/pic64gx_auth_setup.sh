...
export UBOOT_SIGN_KEYNAME="pic64gx_fitimage_key"
export HSS_PAYLOAD_PRIVATE_KEYNAME="x509-ec-secp384r1-private"
export HSS_PAYLOAD_PUBLIC_KEYNAME="x509-ec-secp384r1-public"

main () {
    if [ "$_" = "$0" ]; then
        echo "Please run . ./meta-pic64gx-yocto-bsp/pic64gx_yocto_setup.sh before running this script"
        return
    fi
...
print_usage () {
    echo ""
    echo "Usage: pic64gx_auth_setup.sh [-o <path>] [-h]"
    echo ""
